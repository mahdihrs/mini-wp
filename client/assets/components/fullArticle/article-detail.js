Vue.component('article-detail', {
    ...
    methods: {
        ...
        populateData() {
            ...
            axios.get(`http://localhost:3000/articles/${this.fullarticle._id}`, {
                headers: {
        ...
        updateData() {
            axios.put(`http://localhost:3000/articles/${this.fullarticle._id}`, {
                title: this.title,
    ...
    <div class="container my-5">
        ...
        <div class="card text-center">
            ...
            <div class="card-body" v-if="seeFullDetailArticle">
                ...
                <img :src="fullarticle.imgUrl" alt="" width="70%" class="my-4"/>
