Vue.component('side-menu-mysites', {
    data() {
        return {
    ...
    methods: {
        ...
        allArticleInThisUniverse() {
            this.$emit('all-articles-in-the-universe')
        }
    },
    template: `
        <div id="sideMenu" class="mr-3 px-4 py-3 border col-1.5">
                <p id="sub-title">Functional Buttons</p>
                <a href="#" style="color: red !important;" class="side-button" @click=allArticleInThisUniverse><img src="https://img.icons8.com/wired/48/000000/google-sites.png" height="25px" alt="" class="pb-1"> General</a><br>
                <a href="#" style="color: red !important;" class="side-button" @click="showAllArticles"><img src="https://img.icons8.com/wired/64/000000/note.png" height="25px" alt="" class="pb-1"> My Articles</a><br>
